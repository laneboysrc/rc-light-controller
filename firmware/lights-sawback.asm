...
;
;
;   This file contains the business logic to drive the LEDs for the GMade
;   Sawback (Willy's Jeep).
;
...
;
;       OUT0    Main beam front left
;       OUT1    Main beam front right
;       OUT2    Indicator front right
...
;       OUT10   
;       OUT11   
;       OUT12   Tail/Brake/Indicator rear left
;       OUT13   Tail/Brake/Indicator rear right
;       OUT14   
;       OUT15   
;
;******************************************************************************
