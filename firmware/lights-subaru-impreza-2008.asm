...
;
;       OUT0    Indicator rear left
;       OUT1    Indicator rear right
;       OUT2    Reversing light left
;       OUT3    Reversing light right
;       OUT4    Tail rear left
;       OUT5    Tail rear right
;       OUT6    Brake rear left
;       OUT7    Brake rear right
;       OUT8    Indicator front left
;       OUT9    Indicator front right
;       OUT10   Main beam front left
;       OUT11   Main beam front right
;       OUT12   High beam front left
;       OUT13   High beam front right
;       OUT14   
;       OUT15   
;
;******************************************************************************
...
#define LED_MAIN_BEAM_L 10
#define LED_MAIN_BEAM_R 11
#define LED_HIGH_BEAM_L 12
