...
;   generic-lights.asm
;
;   This file contains the business logic to drive the LEDs in a generic
;   fashion, i.e. not for a specific car.
;
;   The hardware is based on PIC16F1825 and TLC5940. No DC/DC converter is used.
;
;   The TLC5940 IREF is programmed with a 510 Ohms resistor, which means
;   the maximum LED current is 76.6 mA (39.06 / R). 
;   Each adjustment step is 1.216 mA.
;
;
