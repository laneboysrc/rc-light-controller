...
;   lights-bogdan.asm
;
;   This file contains the business logic to drive the LEDs for Bogdan's
;   Subaru BRZ. It is derived form lights-generic with a few minor changes.
;   Bogdan contacted us via GMail.
;
;   The hardware is based on PIC16F1825 and TLC5940. No DC/DC converter is used.
;
;   The TLC5940 IREF is programmed with a 1000 Ohms resistor, which means
;   the maximum LED current is 39 mA (39.06 / R).
;   Each adjustment step is 0.619 mA.
;
;
...
;       OUT6    Indicator front left (40 mA!)
;       OUT7    Indicator front right  (40 mA!)
;       OUT8    Roof light (40mA!)
;       OUT9    3rd Brake light
