...
;
;       OUT0    Tail rear left
;       OUT1    Tail rear right
;       OUT2    Brake rear left
;       OUT3    Brake rear right
;       OUT4    Indicator rear left
;       OUT5    Indicator rear right
;       OUT6    Reversing light left 
;       OUT7    Reversing light right
;       OUT8    Main beam front left
;       OUT9    Main beam front right
;       OUT10   High beam front left
;       OUT11   High beam front right
;       OUT12   Indicator front left
;       OUT13   Indicator front right
;       OUT14   
;       OUT15   
;
;******************************************************************************
...
;
;******************************************************************************
    TITLE       Light control logic for the Tamiya Subaru Impreza WRC 2008
    RADIX       dec
...
#define LED_MAIN_BEAM_L 8
#define LED_MAIN_BEAM_R 9
#define LED_HIGH_BEAM_L 10
#define LED_HIGH_BEAM_R 11
#define LED_INDICATOR_F_L 12    
#define LED_INDICATOR_F_R 13
#define LED_INDICATOR_R_L 4   
#define LED_INDICATOR_R_R 5
#define LED_TAIL_L 0   
#define LED_TAIL_R 1    
#define LED_BRAKE_L 2    
#define LED_BRAKE_R 3   
#define LED_REVERSING_L 6  
#define LED_REVERSING_R 7    
...
#define VAL_REVERSE (4 * 1000 / uA_PER_STEP)
