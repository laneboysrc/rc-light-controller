...
;       OUT8    
;       OUT9    
;       OUT10   Parking light left
;       OUT11   Parking light right
...
;
;******************************************************************************
    TITLE       Light control logic for the HPI Porsche 911 RSR
    RADIX       dec
...
#define LED_PARKING_L 10   
#define LED_PARKING_R 11    
