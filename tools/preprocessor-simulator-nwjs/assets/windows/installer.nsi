...
!define FILE_NAME_INSTALLER   "preprocessor-simulator-installer_${VERSION}_${PLATFORM}.exe"
!define FILE_NAME_UNINSTALLER "uninstall-preprocessor-simulator.exe"
!define FILE_NAME_EXECUTABLE  "preprocessor-simulator.exe"
